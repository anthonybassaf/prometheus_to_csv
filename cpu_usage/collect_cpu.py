        ...
        if "TRIGRAMME" in self.table_name:
            ...
            if 'loop' in metric_from_file and "TRUE" in metric_from_file['loop']:
                ...
                for num_server in metric_from_file['num_server'].split():
                    ...
                    metric_list.append(MetricServer(name, site, mode, dmi_info_value, num_server))
                ...
                metric_list.append(MetricServer(name, site, mode, dmi_info_value, metric_from_file['num_server']))
            ...
            metric_list.append(MetricGlobale(name, site, mode, dmi_info_value))
