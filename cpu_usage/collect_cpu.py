...
class CSVDataWriter(object):
    ...
    def createNewMetrics(self, metric_from_file, my_date):
        ...
        cpu_value = metric_from_file['query']      
                
        metric_list = []

        if "TRIGRAMME" in self.table_name:
            metric_list.append(MetricTrigramme(name, site, mode, cpu_value))
            ...
            if 'loop' in metric_from_file and "TRUE" in metric_from_file['loop']:
                ...
                for num_server in metric_from_file['num_server'].split():
                    ...
                    metric_list.append(MetricServer(name, site, mode, cpu_value, num_server))
                ...
                metric_list.append(MetricServer(name, site, mode, cpu_value, metric_from_file['num_server']))
            ...
            metric_list.append(MetricGlobale(name, site, mode, cpu_value))
